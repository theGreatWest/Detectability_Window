...
for photo in photo_list:
    answer_img[i] = tkinter.Label(window, image=photo, background='black',
                                  border=2, width=310, height=310, highlightcolor='white')
    i += 1
...
a = tkinter.Label(window, text=expla[0], background="white",
                  foreground='black', font='Helvetica 14 bold')
a.place(x=38, y=0)

answer_img[1].place(x=367, y=0)
b = tkinter.Label(window, text=expla[1], background="white",
                  foreground='black', font='Helvetica 14 bold')
b.place(x=405, y=0)

answer_img[2].place(x=734, y=0)
c = tkinter.Label(window, text=expla[2], background="white",
                  foreground='black', font='Helvetica 14 bold')
c.place(x=772, y=0)

answer_img[3].place(x=1100, y=0)
d = tkinter.Label(window, text=expla[3], background="white",
                  foreground='black', font='Helvetica 14 bold')
d.place(x=1138, y=0)

answer_img[4].place(x=0, y=310)
e = tkinter.Label(window, text=expla[4], background="white",
                  foreground='black', font='Helvetica 14 bold')
e.place(x=38, y=310)

answer_img[5].place(x=367, y=310)
f = tkinter.Label(window, text=expla[5], background="white",
                  foreground='black', font='Helvetica 14 bold')
f.place(x=405, y=310)

answer_img[6].place(x=734, y=310)
g = tkinter.Label(window, text=expla[6], background="white",
                  foreground='black', font='Helvetica 14 bold')
g.place(x=772, y=310)

answer_img[7].place(x=1100, y=310)
h = tkinter.Label(window, text=expla[7], background="white",
                  foreground='black', font='Helvetica 14 bold')
h.place(x=1138, y=310)

answer_img[8].place(x=0, y=620)
i = tkinter.Label(window, text=expla[8], background="white",
                  foreground='black', font='Helvetica 14 bold')
i.place(x=38, y=620)

answer_img[9].place(x=367, y=620)
j = tkinter.Label(window, text=expla[9], background="white",
                  foreground='black', font='Helvetica 14 bold')
j.place(x=405, y=620)
...
nt = tkinter.Label(window, text="Tutorial Finished",
                   background='black', foreground='white', font='Helvetica 14 bold')
nt.place(x=990, y=700)

retry = tkinter.Button(window, text='', background='white', foreground='black', font='Helvetica 16 bold',
                       relief='groove', borderwidth=1, width=14, height=2, highlightcolor='white', highlightbackground='white')
if get_num() == 2:
